...
use egui::{CursorIcon, Id, Layout, Pos2, Rect, CornerRadius, Sense, Ui, Vec2};
...
impl Splitter {
    ...
    pub fn show(mut self, ui: &mut Ui, add_contents: impl FnOnce(&mut Ui, &mut Ui)) {
        ...
        let mut ui_a = ui.new_child(child_rect_a, Layout::default());
        ...
        let mut ui_b = ui.new_child(child_rect_b, Layout::default());
